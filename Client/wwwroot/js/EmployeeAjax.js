    ...
    $('#tabelEmployee').DataTable({
        ...
        'columns': [
            ...
            },
            {
                "data": "",
                "render": function (data, type, row, meta) {
                    var btn = '<button onclick="Delete(' + row['nik'] + ');" class="btn"><i class="fa fa-trash"></i></button><button onclick="Get(' + row['nik'] + ');" id="btnEdit" data-toggle="modal" data-target="#formEdit" class="btn"><i class="fa fa-edit"></i></button>';
                    return btn;
                }
            }
        ]
